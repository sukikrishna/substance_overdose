...
for i in range(10):
    ...
    for look_back in look_backs:
        ...
        val_df.to_csv(f'../tables_seeds/seed{seed}/batch_{bs}_loss_mse_epoch_{num_epochs}/trial_{trial_num}_{look_back}month_predictionresults_batch_{bs}_loss_{ls}_epochs_{num_epochs}.csv')